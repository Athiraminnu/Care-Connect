...
SECRET_KEY = 'django-insecure-92w5-2!r^+)wbi34v*ajfzsb*-j3xbb@6re92_@68j6$)))bzu'
...
MIDDLEWARE = [
    ...
    'corsheaders.middleware.CorsMiddleware',  # Make sure CORS middleware is included if needed
